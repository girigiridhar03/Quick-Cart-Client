          ...
          <FieldGroup>
            <Field>
              ...
              <Input
                ...
                onChange={onChange}
                className="font-bold text-black lg:text-[17px] focus:bg-white px-6 bg-[#F7F7F7] rounded-2xl shadow-none h-12 lg:h-15 py-6"
            ...
            <Field className="w-full px-2">
              ...
              <Textarea
                name="body"
                value={reviewDetails.body}
                onChange={onChange}
                className="bg-[#F7F7F5] lg:text-[17px] font-bold resize-none h-40 lg:h-50 px-5 py-6 rounded-2xl focus:bg-white shadow-none"
